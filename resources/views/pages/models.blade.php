        ...
        <div class="sm:flex sm:items-baseline">
            ...
            <div class="mt-4 sm:mt-0 sm:ml-10">
                <nav class="-mb-px flex space-x-8">
                    ...
                    <a href="{{ route('stickle::models', ['modelClass' => $modelClass]) }}"
                        class="border-b-2 border-indigo-500 px-1 pb-4 text-sm font-medium whitespace-nowrap text-indigo-600"
                        aria-current="page">All</a>
                    <a href="{{ route('stickle::segments', ['modelClass' => $modelClass]) }}"
                        class="border-b-2 border-transparent px-1 pb-4 text-sm font-medium whitespace-nowrap text-gray-500 hover:border-gray-300 hover:text-gray-700">Segments</a>
                </nav>
            </div>
        </div>
    </div>
