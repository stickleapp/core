...
<div x-data="{ isOpen: false }">
  ...
  <div x-show="isOpen" class="relative z-50 lg:hidden" role="dialog" aria-modal="true">
    ...
    x-transition:leave-start="opacity-100"
    x-transition:leave-end="opacity-0" class="absolute top-0 left-full flex w-16 justify-center pt-5">
          <button type="button" @click="isOpen = !isOpen" class="-m-2.5 p-2.5">
  ...
  <div class="lg:pl-72">
    <div class="sticky top-0 z-40 lg:mx-auto lg:max-w-7xl lg:px-8">
      <div class="flex h-16 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-xs sm:gap-x-6 sm:px-6 lg:px-0 lg:shadow-none">
        <button type="button" @click="isOpen = true" class="-m-2.5 p-2.5 text-gray-700 lg:hidden">
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          ...
          <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <div x-data="{ isProfileMenuOpen: false }" class="relative">
              <button type="button" @click="isProfileMenuOpen = !isProfileMenuOpen" class="-m-1.5 flex items-center p-1.5" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
    ...
    x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 ring-1 shadow-lg ring-gray-900/5 focus:outline-hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
